...
* [**Balabolka**](http://www.cross-plus-a.com/balabolka.html) - Free text-to-speech converter. It uses the free Microsoft Sapi 4 and Sapi 5 voices. Voices can be downloaded from: http://www.zero2000.com/free-text-to-speech-natural-voices.html. They also have voices in several different languages. It is very simple to install and use and the files can be saved in .wav, .mp3, .mp4, .oog, and several others formats.
